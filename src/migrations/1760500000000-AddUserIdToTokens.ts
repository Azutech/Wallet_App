...
export class AddUserIdToTokens1760396094759 implements MigrationInterface {
  name = 'AddUserIdToTokens1760396094759';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "tokens" ALTER COLUMN "userId" DROP NOT NULL`,
    );
    await queryRunner.query(
