...
export class SetWallets1760481475144 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."payment_status_enum" AS ENUM('pending', 'success', 'failed', 'refunded')`);
        await queryRunner.query(`CREATE TYPE "public"."payment_method_enum" AS ENUM('card', 'bank_transfer', 'wallet')`);
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD "transactionPin" character varying`);
